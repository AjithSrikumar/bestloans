...
export const metadata: Metadata = {
  ...
  description:
    "Compare home loans from 25+ banks. Fast approval, lowest interest rates. Apply online in minutes with BestLoans.",
  keywords: [
    "home loan",
    "best home loan",
    "compare home loans",
  ...
  openGraph: {
    ...
    description:
      "Compare home loans from 25+ banks. Fast approval, lowest interest rates.",
